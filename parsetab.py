...
_lr_productions = [
  ...
  ('expr -> expr PLUS expr','expr',3,'p_add','parser.py',13),
  ('expr -> expr MINUS expr','expr',3,'p_sub','parser.py',17),
  ('expr -> MINUS expr','expr',2,'p_expr2uminus','parser.py',21),
  ('expr -> expr TIMES expr','expr',3,'p_mult_div','parser.py',25),
  ('expr -> expr DIV expr','expr',3,'p_mult_div','parser.py',26),
  ('expr -> NUMBER','expr',1,'p_expr2NUM','parser.py',37),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_parens','parser.py',41),
]
